...
|  `POSTGRESQL_ENABLE_REPLICATION`  | Streaming replication is enabled by default and requires up to 6.25 GiB additional disk space. Set to `false` if you don't need replication and want to run PostgreSQL with a small persistent volume |  true
